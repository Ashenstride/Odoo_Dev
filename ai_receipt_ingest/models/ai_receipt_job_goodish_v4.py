...
class AiReceiptJob(models.Model):
    ...
    def _heuristic_bucket_for_line(self, description, amount, threshold):
        ...
        raw_material_keywords = [
            'copper', 'silver', 'brass', 'bronze', 'shibuichi', 'shakudo', 'mesh',
            ...
            'metal powder', 'powder', 'casting grain',
        ]
        office_keywords = [
            'paper', 'notebook', 'pen', 'pencil', 'staple', 'label', 'printer paper', 'envelope',
        ]
        software_keywords = [
            'software', 'subscription', 'saas', 'license', 'cloud', 'adobe', 'fusion 360',
        ]
        marketing_keywords = [
            'ad', 'advertising', 'promotion', 'promotional', 'marketing', 'business card',
            'flyer', 'banner', 'booth',
        ]
        ...
        food_keywords = ['catering', 'delivery', 'food']
